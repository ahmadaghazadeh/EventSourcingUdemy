...
namespace Post.Query.Infrastructure.Converters
{
	...
	{
		public override bool CanConvert(Type typeConvertor)
		{
			return typeConvertor.IsAssignableFrom(typeof(BaseEvent));
		}
		...
		public override BaseEvent? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			...
			return typeDiscriminator switch
			{
				...
				nameof(CommandUpdatedEvent) => JsonSerializer.Deserialize<CommandUpdatedEvent>(json, options),
